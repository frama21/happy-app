...
<body>
								...
								<div class="load">
									<div class="card-content black-text">
										<div class="container" style="padding-top: 20px">
											...
											$alay=array( "4","3","C","d)","3","F","9","(-)","!","J","I
											<","I_","111","11","()","P","Q","12","5","7","(_)","\/","UU","X","Y","Z");
												$text=$_POST['text']; $kecil=strtolower($text);
												$hasil=str_replace($asli,$alay,$kecil); }; @endphp <div class="row">
												<div class="col s12 m12">
													<div class="input-field">
														<i class="material-icons prefix">chevron_right</i>
														<textarea style="color:black !important;"
															class="materialize-textarea" id="hasil"
															disabled>@php echo @$hasil; @endphp</textarea>
						...
						<div class="card-action black-text" style="border-radius: 0px 0px 10px 10px;">
							...
							<div class="right">
								<button style="border-radius: 20px; background-color: #f7d108 !important;"
									class="click-trigger btn waves-effect waves-teal" data-click-id="click-001"
									name="submit" type="submit" id="quoteBtn" onClick="onClick()">Translate</button>
							</div>
						</div>
						</form>
	...
	<div class="row center">
		<div class="col s6 m6">
			<h4>Translate<br><a id="click-001" style="color: #FFD600;" class="click-count">@php echo
					$count['click-001'];@endphp</a></h4>
		</div>

		<div class="col s6 m6">
			<h4>Copied<br><a id="click-001" style="color: #FFD600;" class="click-count">@php echo
					$count['click-002'];@endphp</a></h4>
		</div>
	</div>
	</div>
