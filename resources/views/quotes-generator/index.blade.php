...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" alt="icon"/>
				...
				<div class="container p">
					<div class="col s12 m12">
						<div class="card z-depth-5 card-p" style="border-radius: 10px;">
							<div class="progress" style="border-radius: 10px 10px 0px 0px; width: 98%; margin-left: 4px;">
					        ...
					        <div class="card-action black-text" style="border-radius: 0px 0px 10px 10px;">
					        	<button class="click-trigger pick btn-floating green waves-effect waves-light tooltipped" data-click-id="click-002" data-clipboard-targets="#quote,#author" data-position="right" data-tooltip="Copy to Clipboard" id="copy">
					        		<i class="material-icons">content_copy</i>
					        	</button>
					        	<div class="right">
					        		<button style="border-radius: 20px;" class="click-trigger btn blue waves-effect waves-blue" data-click-id="click-001" type="button" id="quoteBtn" onClick="onClick()">Generate</button>
					        	</div>
					        </div>
...
<br>
		...
		<div class="row center">
			<div class="col s6 m6">
				<h4>Quotes Generate<br><a id="click-001" class="click-count">@php echo $count['click-001'];@endphp</a></h4>
			</div>
			<div class="col s6 m6">
				<h4>Quotes Copied<br><a id="click-002" class="click-count">@php echo $count['click-002'];@endphp</a></h4>
			</div>
		</div>
	</div>	
